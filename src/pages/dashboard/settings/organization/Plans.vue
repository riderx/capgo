                ...
                <div class="w-full px-16 py-8 lg:px-16 lg:py-14 sm:px-8 bg-blue-50">
                  <div class="w-full md:flex md:items-center lg:space-x-6 md:space-x-4">
                    ...
                    <div class="!mx-auto mt-10 md:mt-0">
                      <button
                        class="inline-flex items-center justify-center p-6 mt-5 text-base font-bold text-gray-300 transition-all duration-200 bg-black border font-pj rounded-xl hover:bg-black/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                        @click="openSupport()"
                      >
                        Get quote now
                      </button>
